rm results.txt
echo "compiling..."
g++ reduction.cpp -std=c++11 `pkg-config --cflags --libs opencv` -lpthread -fopenmp -lm
echo "runing..."
...
./a.out "./imgs/img4k.jpg" "./img_result/img4k_16t.jpg" 12 >> results.txt
...
./a.out "./imgs/img1080.jpg" "./img_result/img1080_8t.jpg" 12 >> results.txt
